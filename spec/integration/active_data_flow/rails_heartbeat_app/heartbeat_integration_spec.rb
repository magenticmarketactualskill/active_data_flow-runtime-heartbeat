...
RSpec.describe "Heartbeat Integration", type: :request do
  ...
  describe "end-to-end flow execution" do
    it "creates flow record, triggers heartbeat, verifies execution and run record" do
      # Create flow record
      flow = ActiveDataFlow::Runtime::Heartbeat::DataFlow.create!(
        name: "test_flow",
        run_interval: 60,
  ...
  describe "multiple flows with different intervals" do
    it "executes only due flows" do
      ...
      due_flow_1 = ActiveDataFlow::Runtime::Heartbeat::DataFlow.create!(
        name: "due_flow_1",
        run_interval: 60,
      ...
      due_flow_2 = ActiveDataFlow::Runtime::Heartbeat::DataFlow.create!(
        name: "due_flow_2",
        run_interval: 120,
      ...
      not_due_flow = ActiveDataFlow::Runtime::Heartbeat::DataFlow.create!(
        name: "not_due_flow",
        run_interval: 3600,
  ...
  describe "failed flow doesn't block execution of other flows" do
    ...
    it "continues executing other flows when one fails" do
      ...
      success_flow = ActiveDataFlow::Runtime::Heartbeat::DataFlow.create!(
        name: "success_flow",
        run_interval: 60,
        configuration: { "class_name" => "MockFlow" }
      )
