...
RSpec.describe ActiveDataFlow::Runtime::Heartbeat::DataFlow, type: :model do
  ...
  describe "#trigger_run!" do
    it "delegates to FlowExecutor" do
      ...
      expect(ActiveDataFlow::Runtime::Heartbeat::FlowExecutor).to receive(:execute).with(flow)
      flow.trigger_run!
    end
  end
end
